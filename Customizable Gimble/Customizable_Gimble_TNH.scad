...
// Usage: 
//
// Upload an image to Benjamin's Stencil-o-Matic to generate data for your 
// gimbal. Paste the code into the "input" field of Customizer. You can make
// additional changes to the size and position of your image within Customizer.
//
